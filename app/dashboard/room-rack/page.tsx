...
export default async function RoomRackPage() {
  ...
  // Завантажуємо бронювання у робочому вікні: активні блокують шахматку,
  // термінальні показуємо як неактивний історичний шар.
  ...
  for (const res of resvData || []) {
    ...
    for (const rr of rooms) {
      blocks.push({
        ...
        room_id: rr.room_id,
        moved_from_room_id: rr.moved_from_room_id,
        ...
        rate_plan_discount_percentage: Number(r.rate_plans?.discount_percentage ?? 0),
